...
/** FilePen - note / filing action. */
export const ICON_FILE_PEN = `<svg xmlns="http://www.w3.org/2000/svg" ${BASE}><path d="M12 20h-1a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5l4 4v4"/><path d="M14 4v4h4"/><path d="M18.42 15.61a2.1 2.1 0 1 1 2.97 2.97L17 23l-4 1 1-4Z"/></svg>`;
